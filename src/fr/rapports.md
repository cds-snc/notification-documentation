...
Les rapports sont générés de façon asynchrone. Après avoir demandé un rapport, interrogez le rapport par son ID jusqu'à ce que son statut soit `ready`, puis téléchargez son contenu.
...
L'ID de l'envoi en masse pour lequel générer un rapport.
